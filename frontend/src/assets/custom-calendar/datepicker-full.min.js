! function() {
  ...
  function x(e) {
      ...
      const a = s.map(e => b[e]),
          n = Object.keys(y).reduce((e, t) => {
              return s.find(e => e[0] === t) ? (e[t] = y[t], e) : e
          }, {}),
          r = Object.keys(n);
      return D[e] = {
          parser(e, t) {
  ...
  function q(t, s) {
      ...
      if (a.language) {
          ...
          if (a.language !== o && (r[a.language] ? e = a.language : void 0 === r[e = a.language.split("-")[0]] && (e = !1)), delete a.language, e) {
              ...
              c = Object.assign({
                  format: T,
                  weekStart: P
              }, r[j]), o !== j && Object.assign(c, r[o]), n.locale = c, d === t.format && (d = n.format = c.format), m === t.weekStart && (m = n.weekStart = c.weekStart, n.weekEnd = K(c.weekStart))
          }
      }
      if (a.format) {
      ...
      let g = f,
          k = h;
      if (void 0 !== a.minDate && (g = null === a.minDate ? l(0, 0, 1) : _(a.minDate, d, c, g), delete a.minDate), void 0 !== a.maxDate && (k = null === a.maxDate ? void 0 : _(a.maxDate, d, c, k), delete a.maxDate), k < g ? (f = n.minDate = k, h = n.maxDate = g) : (f !== g && (f = n.minDate = g), h !== k && (h = n.maxDate = k)), a.datesDisabled && (n.datesDisabled = a.datesDisabled.reduce((e, t) => {
              const s = S(t, d, c);
      ...
      if (void 0 !== a.weekStart) {
          ...
          isNaN(e) || (m = n.weekStart = e, n.weekEnd = K(e)), delete a.weekStart
      }
      if (a.daysOfWeekDisabled && (n.daysOfWeekDisabled = a.daysOfWeekDisabled.reduce(R, []), delete a.daysOfWeekDisabled), a.daysOfWeekHighlighted && (n.daysOfWeekHighlighted = a.daysOfWeekHighlighted.reduce(R, []), delete a.daysOfWeekHighlighted), void 0 !== a.maxNumberOfDates) {
      ...
      let y = p;
      if (void 0 !== a.startView && (y = I(a.startView, y), delete a.startView), (y = u < y ? u : y) !== p && (n.startView = y), a.prevArrow) {
      ...
      performBeforeHook(e, t, s) {
          ...
          if (a) {
              ...
              a.content && function(e, t) {
                  $(e), t instanceof DocumentFragment ? e.appendChild(t) : "string" == typeof t ? e.appendChild(W(t)) : "function" == typeof t.forEach && t.forEach(t => {
                      e.appendChild(t)
                  })
              }(e, a.content)
          }
  ...
  class G extends X {
      ...
      setOptions(t) {
          ...
          if (e(t, "minDate") && (this.minDate = t.minDate), e(t, "maxDate") && (this.maxDate = t.maxDate), t.datesDisabled && (this.datesDisabled = t.datesDisabled), t.daysOfWeekDisabled && (this.daysOfWeekDisabled = t.daysOfWeekDisabled, i = !0), t.daysOfWeekHighlighted && (this.daysOfWeekHighlighted = t.daysOfWeekHighlighted), void 0 !== t.todayHighlight && (this.todayHighlight = t.todayHighlight), void 0 !== t.weekStart && (this.weekStart = t.weekStart, this.weekEnd = t.weekEnd, i = !0), t.locale) {
              ...
              this.dayNames = e.daysMin, this.switchLabelFormat = e.titleFormat, this.switchLabel = M(this.picker.viewDate, e.titleFormat, e), i = !0
          }
          ...
          void 0 !== t.showDaysOfWeek && (t.showDaysOfWeek ? (H(this.dow), this.calendarWeeks && H(this.calendarWeeks.dow)) : (Y(this.dow), this.calendarWeeks && Y(this.calendarWeeks.dow))), i && Array.from(this.dow.children).forEach((e, t) => {
      ...
      updateFocus() {
          ...
          this.first = s, this.last = l(t, i + 1, 0), this.start = a, this.switchLabel = M(e, this.switchLabelFormat, this.locale), this.focused = this.picker.viewDate
      }
      updateSelection() {
          const {
              dates: e,
  ...
  class Z extends X {
      ...
      updateSelection() {
          this.selected = this.picker.datepicker.dates.reduce((e, t) => i(e, g(t, this.step)), [])
      }
      render() {
  ...
  function ae(t, i) {
      if (void 0 !== i.title && (i.title ? (t.controls.title.textContent = i.title, H(t.controls.title)) : (t.controls.title.textContent = "", Y(t.controls.title))), i.prevArrow) {
          const e = t.controls.prevBtn;
          $(e), i.prevArrow.forEach(t => {
              e.appendChild(t.cloneNode(!0))
          })
      }
      if (i.nextArrow) {
          const e = t.controls.nextBtn;
          $(e), i.nextArrow.forEach(t => {
              e.appendChild(t.cloneNode(!0))
          })
      }
      if (i.locale && (t.controls.todayBtn.textContent = i.locale.today, t.controls.clearBtn.textContent = i.locale.clear), void 0 !== i.todayBtn && (i.todayBtn ? H(t.controls.todayBtn) : Y(t.controls.todayBtn)), e(i, "minDate") || e(i, "maxDate")) {
          const {
              minDate: e,
              maxDate: i
          } = t.datepicker.config;
      ...
      void 0 !== i.clearBtn && (i.clearBtn ? H(t.controls.clearBtn) : Y(t.controls.clearBtn))
  }
  ...
  class oe {
      constructor(e) {
          ...
          i.classList.add(`datepicker-${p}`), ae(this, e.config), this.viewDate = ne(e), V(e, [
              [i, "click", function(e, t) {
                  t.preventDefault(), t.stopPropagation(), !e.inline && e.picker.active && e.inputField.focus()
              }.bind(null, e)],
              ...
              [f.todayBtn, "click", function(e) {
                  ...
                  if (1 === e.config.todayBtnMode) {
                      if (e.setDate(c(), {
                              render: !1
                          }), e.config.autohide) return void e.hide()
          ...
          ]), this.views = [new G(this), new Q(this), new Z(this, {
              id: 2,
              name: "years",
              cellClass: "year",
              step: 1
      ...
      setOptions(e) {
          ae(this, e), this.views.forEach(t => {
              t.init(e, !1)
      ...
      show() {
          ...
          if (!e.inline) {
              ...
              t !== de(e.config.container) ? this.element.dir = t : this.element.dir && this.element.removeAttribute("dir"), this.place(), "ontouchstart" in document && e.config.disableTouchKeyboard && e.inputField.blur()
          }
          ee(e, "show")
      }
      hide() {
      ...
      place() {
          ...
          a === document.body ? (p = window.scrollY, m = l + window.scrollX, g = h + p) : (m = l - d, g = h - o + (p = a.scrollTop)), "auto" === w && (m < 0 ? (w = "left", m = 10) : w = m + n > c ? "right" : "rtl" === de(s) ? "right" : "left"), "right" === w && (m -= n - u), "auto" === k && (k = g - r < p ? "bottom" : "top"), "top" === k ? g -= r : g += f, e.remove("datepicker-orient-top", "datepicker-orient-bottom", "datepicker-orient-right", "datepicker-orient-left"), e.add(`datepicker-orient-${k}`, `datepicker-orient-${w}`), t.top = g ? `${g}px` : g, t.left = m ? `${m}px` : m
      }
      ...
      changeFocus(e) {
          return this._renderMethod = re(this, e) ? "render" : "refreshFocus", this.views.forEach(e => {
              e.updateFocus()
          }), this
      }
      update() {
          const e = ne(this.datepicker);
          return this._renderMethod = re(this, e) ? "render" : "refresh", this.views.forEach(e => {
  ...
  function ce(e, t, i, s) {
      const n = e.picker.currentView,
          r = n.step || 1;
      let d, o, c = e.picker.viewDate;
      switch (n.id) {
          case 0:
              c = s ? h(c, 7 * i) : t.ctrlKey || t.metaKey ? f(c, i) : h(c, i), d = h, o = (e => n.disabled.includes(e));
              break;
          case 1:
              ...
              break;
          default:
              c = f(c, i * (s ? 4 : 1) * r), d = f, o = (e => n.disabled.includes(g(e, r)))
      }
      void 0 !== (c = function e(t, i, s, n, r, d) {
          if (a(t, r, d)) return n(t) ? e(i(t, s), i, s, n, r, d) : t
      }(c, d, i < 0 ? -r : r, o, n.minDate, n.maxDate)) && e.picker.changeFocus(c).render()
  }
  ...
  class ue {
      constructor(e, t = {}, i) {
          ...
          this.dates = he(d, a) || [], i && "DateRangePicker" === i.constructor.name && (this.rangepicker = i, Object.defineProperty(this, "range", {
              get() {
          ...
          if (n) this.show();
              ...
              const e = function(e, t) {
                  const i = e.element,
                      s = e.picker.element;
                  N(t, e => e === i || e === s) || (e.refresh("input"), e.hide())
              }.bind(null, this);
              V(this, [
                      ...
                      if (e.picker.active)
                          if (e.editMode) switch (t.key) {
                              ...
                              case "Escape":
                                  ...
                                  break;
                              case "ArrowLeft":
                                  t.ctrlKey || t.metaKey ? te(e, -1) : ce(e, t, -1, !1);
                                  break;
                              case "ArrowRight":
                                  t.ctrlKey || t.metaKey ? te(e, 1) : ce(e, t, 1, !1);
                                  break;
                              case "ArrowUp":
                                  t.ctrlKey || t.metaKey ? ie(e) : ce(e, t, -1, !0);
                                  break;
                              case "ArrowDown":
                                  ce(e, t, 1, !0);
                                  break;
      ...
      destroy() {
          return this.hide(), E(this), this.picker.detach(), this.inline || this.inputField.classList.remove("datepicker-input"), delete this.element.datepicker, this
      }
      getDate(e) {
          const t = e ? t => M(t, e, this.config.locale) : e => new Date(e);
      ...
      setDate(...e) {
          ...
          d && (d.toString() !== this.dates.toString() ? (this.dates = d, this.picker.update(), this.refresh(s.render ? void 0 : "input"), ee(this, "changeDate")) : this.refresh("input"), s.render && s.autohide && this.hide())
      }
      update(e) {
          ...
          const t = Object.assign({
              ...
              i = he(s(this.inputField.value, this.config.dateDelimiter), this.config);
          i && (i.toString() !== this.dates.toString() ? (this.dates = i, this.picker.update(), this.refresh(), ee(this, "changeDate")) : this.refresh("input"), t.autohide && this.hide())
      }
      refresh(e) {
          if ("input" !== e && this.picker.render(), !this.inline && "picker" !== e) {
              const e = le(this.dates, this.config);
      ...
      exitEditMode(e) {
          ...
          delete this.editMode, this.inputField.classList.remove("in-edit"), t.update ? this.update(t) : this.inputField.value = le(this.dates, this.config)
      }
  }
  ...
  function me(e, t) {
      ...
      const s = e.datepickers,
          ...
          d = s[n].dates[0],
          o = s[r].dates[0];
      void 0 !== d && void 0 !== o ? 0 === n && d > o ? (s[0].setDate(o, a), s[1].setDate(d, a)) : 1 === n && d < o && (s[0].setDate(d, a), s[1].setDate(o, a)) : e.allowOneSidedRange || void 0 === d && void 0 === o || (a.clear = !0, s[r].setDate(s[n].dates, a)), s[0].picker.update().render(), s[1].picker.update().render(), delete e.updating
  }
  window.Datepicker = ue, window.DateRangePicker = class {
      constructor(e, t = {}) {
          ...
          const s = me.bind(null, this),
              a = fe(t);
          this.datepickers = [pe(this, s, this.inputs[0], a), pe(this, s, this.inputs[1], a)], void 0 !== this.dates[0] ? me(this, {
              target: this.inputs[0]
          }) : void 0 !== this.dates[1] && me(this, {
              target: this.inputs[1]
          })
      }
      get dates() {
          if (this.datepickers) return [this.datepickers[0].dates[0], this.datepickers[1].dates[0]]
      }
      setOptions(e) {
      ...
      destroy() {
          this.datepickers[0].destroy(), this.datepickers[1].destroy(), E(this), delete this.element.rangepicker
      }
      getDates(e) {
          const t = e ? t => M(t, e, this.datepickers[0].config.locale) : e => new Date(e);
